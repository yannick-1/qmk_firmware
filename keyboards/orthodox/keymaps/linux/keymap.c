...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_COLEMAK] = LAYOUT(\
        ...
        KC_LSFT,         KC_Z, KC_X, KC_C, KC_V, KC_B, KC_LGUI, LT(1,KC_SPC), MT(KC_LCTL, KC_PGUP),     MT(KC_RCTL, KC_PGDOWN),   LT(2,KC_DEL), KC_LALT, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLASH, KC_RSFT   \
    ),
